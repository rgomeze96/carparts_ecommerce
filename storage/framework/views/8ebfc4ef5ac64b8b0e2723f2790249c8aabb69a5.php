...
<div class="container">
    <div class="card border-secondary m-2">
        <div class="card-header text-center border-secondary"><h5><?php echo e(__('auth.register')); ?></h5></div>
        <div class="card-body">
            <form class="text-center" method="POST" action="<?php echo e(route('user.save')); ?>">
                <?php echo csrf_field(); ?>
...
if (isset($__messageOriginal)) { $message = $__messageOriginal; 
                ...
                <div class="form-group row">
                    <label for="password-confirm"
                        class="col-md-4 col-form-label text-md-right"><?php echo e(__('auth.confirmPassword')); ?></label>
                    <div class="col-md-6">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**
                                                                                                                                      * 
                                                                                                                                      * PATH C:\xampp\htdocs\carparts_ecommerce\resources\views/auth/register.blade.php ENDPATH
                                                                                                                                      **/ ?>
