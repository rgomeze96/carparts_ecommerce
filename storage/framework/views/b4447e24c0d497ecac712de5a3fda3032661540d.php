...
<div class="container">
    <div class="row justify-content-center"><h2><?php echo e(__('flowers.title')); ?></h2></div>
    ...
    <div class="row shadow-lg rounded rounded-pill m-2">
        <div class="row mx-auto">
            <div class="col mt-2 mb-2">
                <h4><?php echo e(__('flowers.name')); ?>: <a class="text-secondary" target="_blank" href="<?php echo e($data['links'][$i]); ?>"><?php echo e($data['flowerNames'][$i]); ?></a>
                </h4>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**
                                                                                                                                      * PATH C:\xampp\htdocs\carparts_ecommerce\resources\views/flowers/index.blade.php ENDPATH
                                                                                                                                      **/ ?>